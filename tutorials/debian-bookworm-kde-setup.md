...
```shell
sudo apt install synaptic filelight sweeper dolphin-plugins printer-driver-all system-config-printer power-profiles-daemon powerdevil kaccounts-* kio-gdrive -y
```
