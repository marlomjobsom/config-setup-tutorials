...
alias inspiron_to_wd='pyrsync --origin ~/ --dest /media/marlom/marlom_backup/ --folders Android Áudiolivros Documentos Downloads Imagens Música ProgramasRFB Softwares VMs Workspace Vídeos .steam .local/share/Zeal/Zeal/docsets .PlayOnLinux/wineprefix/ .pyenv .ssh .receitanet --files .agignore .bash_aliases .bash_profile .ctags .gitconfig --enable_all --exclude *~ *pyc argparse sys .fuse* *swp'
