...
alias wd_to_fedora_desktop='pyrsync --origin /run/media/marlom/marlom_backup/ --dest ~/ --folders Android Áudiolivros Documentos Downloads Imagens Música ProgramasRFB Softwares "VirtualBox VMs" Workspace Vídeos .steam .local/share/Zeal/Zeal/docsets .PlayOnLinux/wineprefix/ .pyenv .ssh .receitanet --files .bash_aliases .bash_profile .ctags .gitconfig --enable_all --exclude *~ *pyc argparse sys .fuse* *swp'
